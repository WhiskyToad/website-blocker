...
// import { redirectExtensionPath, getNextBlockedSiteIndex, transformChromeRuleToIBlockedSite } from './utils.ts';
...
// function getBlockChromeRule(id: number, domain: string): chrome.declarativeNetRequest.Rule {
//   return {
//     id,
//     action: {
